...
import personal.edu.news.quicksidebardemo.constants.DataConstants;
import personal.edu.news.quicksidebardemo.constants.ExpressCom;
import personal.edu.news.quicksidebardemo.model.City;

public class MainActivity_main extends AppCompatActivity implements OnQuickSideBarTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnInclick(new CityListWithHeadersAdapter.OnInclick() {
            @Override
            public void send(int position) {
                Log.i("msg","快递公司选择完毕");
                Shade_Main.setcourier(MainActivity_main.this,cities.get(position).getExpName());
                Shade_Main.setcouriername(MainActivity_main.this,cities.get(position).getExpSpellName());
                finish();
            }
        });
    }
    ...
    private static class CityListWithHeadersAdapter extends CityListAdapter<RecyclerView.ViewHolder>
        ...
        public OnInclick getOnInclick() {
            return onInclick;
        }

        public void setOnInclick(OnInclick onInclick) {
            this.onInclick = onInclick;
        }

        public interface OnInclick{
